...
```javascript
arraybuffer2buffer = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/buffer-from-arraybuffer@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/buffer-from-arraybuffer@umd/bundle.js"></script>
```
